/* =====================================================================
   ...
   3. このファイルは読み込み完了で早めに上げるだけ。最短 2500ms は見せる
...
(function () {
	...
	/* 幕の中の最後の動きは「句を挟む罫」で、1000ms に始まり 500ms かけて
	   引かれる（＝1500ms で引き終わる）。
	   そこから **1000ms（500+500）待って**から上げる ―
	   「この形で少し待って」という指示。完成した版面を見せる時間で、
	   ここが幕の一番の見どころ。動かさないことで読ませる。 */
	var MIN = 2500;

	/* 動きを嫌う人には、静止した完成形を2.5秒見せることになる。
